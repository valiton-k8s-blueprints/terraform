...
| <a name="output_vpc_default_vpc_security_group_id"></a> [vpc\_default\_vpc\_security\_group\_id](#output\_vpc\_default\_vpc\_security\_group\_id) | The ID of the security group created by default on VPC creation |
